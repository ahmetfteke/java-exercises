 ...
 * @author tq
 */
public class UsersUID extends javax.swing.JFrame {
     ...
     */
    public UsersUID() throws ClassNotFoundException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("UserFax:");

        jTextField1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel5.setText("UserLastName:");
        ...
        jLabel10.setText("UserAddress:");

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel3.setText("UserPassword:");

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel4.setText("UserFirstName:");

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel6.setText("UserEmailVeried:");

        jLabel7.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel7.setText("UserIP:");

        jTextField5.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N

        jLabel8.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel8.setText("UserPhone:");
    ...
    private void insertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertActionPerformed
       try{
            ...
            String query = "INSERT INTO `users`(`UserID`, `UserEmail`, `UserPassword`, `UserFirstName`, `UserLastName`, `UserEmailVeried`, `UserIP`, `UserPhone`, `UserFax`, `UserAddress`)"
            + " values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        try{
            ...
            String query = "UPDATE `users` SET `UserEmail`=?,`UserPassword`=?,`UserFirstName`=?,`UserLastName`=?,`UserEmailVeried`=?,`UserIP`=?,`UserPhone`=?,`UserFax`=?,`UserAddress`=? WHERE `UserID`=?";
            PreparedStatement preparedStmt = conn.prepareStatement(query);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsersUID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new UsersUID().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(UsersUID.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
