 ...
 * @author tq
 */
public class ProviderUID extends javax.swing.JFrame {
     ...
     */
    public ProviderUID() throws ClassNotFoundException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ProviderName:");

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel3.setText("ProviderLocation:");
    ...
    private void insertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertActionPerformed
        try{
            ...
            String query = "INSERT INTO `provider`(`ProviderId`, `ProviderName`, `ProviderLocation`)"
            + " values (?, ?, ?)";
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        try{
            ...
            String query = "UPDATE `provider` SET `ProviderName`=?,`ProviderLocation`=? WHERE `ProviderId`=?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProviderUID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ProviderUID().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(ProviderUID.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
