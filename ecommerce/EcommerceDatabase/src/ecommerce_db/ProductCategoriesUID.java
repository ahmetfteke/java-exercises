 ...
 * @author tq
 */
public class ProductCategoriesUID extends javax.swing.JFrame {
     ...
     */
    public ProductCategoriesUID() throws ClassNotFoundException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("CategorySubName:");
    ...
    private void insertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertActionPerformed
        try{
            ...
            String query = " INSERT INTO `productcategories`(`CategoryId`, `CategorySubName`, `CategoryName`)"
            + " values (?, ?, ?)";
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        try{
            ...
            String query = "DELETE FROM `productcategories` WHERE `CategoryId`=?";
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        try{
            ...
            String query = "UPDATE `productcategories` SET `CategorySubName`=?,`CategoryName`=? WHERE `CategoryId`=?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductCategoriesUID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new ProductCategoriesUID().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(ProductCategoriesUID.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
